            ...
            <div class="col-md-12">
                ...
                <div class="form-section">
                    <form wire:submit.prevent="storeProduct">
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control" name="selling_price" wire:model="selling_price"
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control" name="purchase_price" wire:model="purchase_price"
